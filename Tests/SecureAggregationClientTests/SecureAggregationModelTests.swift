...
//    }
    ...
    func testRound1() {
        ...
        do {
            ...
            try model.processRound0Data(SecureAggregationModel<SAInt>.Round0ServerData(collectedData: [PublicKeysOfUser(userID: 5, c_publicKey: SAPubKeyCurve.KeyAgreement.PrivateKey().publicKey, s_publicKey: SAPubKeyCurve.KeyAgreement.PrivateKey().publicKey)]))
